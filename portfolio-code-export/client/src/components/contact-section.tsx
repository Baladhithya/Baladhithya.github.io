            ...
            {showContactForm && (
              <div className="animate-fadeIn">
                ...
                {formSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="border border-white/10 p-4 bg-black/50">
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="form-group">
                          ...
                          <input 
                            ...
                            className="w-full px-3 py-2 bg-black border border-white/20 text-white placeholder-white/40 focus:border-green-400 focus:outline-none focus:ring-0"
                            required
                          />
                        </div>
                      ...
                      <div className="form-group">
                        <label htmlFor="subject" className="block text-white/70 text-xs mb-1">SUBJECT</label>
                        <input 
                          type="text" 
                          id="subject" 
                          name="subject" 
                      ...
                      <div className="pt-2 border-t border-white/10">
                        <Button 
                          type="submit" 
                          className="bg-green-400 hover:bg-green-500 text-black px-6 py-2 font-mono text-sm border border-green-400/50 hover:border-green-500/50"
                        >
                          $ send_message
                        </Button>
                      </div>
