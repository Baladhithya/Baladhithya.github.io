      ...
      <div className="max-w-screen-lg mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className={`${inView ? 'animate-fadeIn' : 'opacity-0'}`} style={{animationDelay: '0.2s'}}>
            ...
            {/* Terminal buttons section */}
            <div className="flex flex-wrap gap-4">
              <a 
                href={personalInfo.github} 
                target="_blank"
                rel="noopener noreferrer"
                className="border border-white/50 bg-black hover:bg-white hover:text-black text-white px-4 py-2 font-mono text-sm transition-colors"
